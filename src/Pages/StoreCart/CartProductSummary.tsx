...
function CartProductSummary() {
    return(
        <div className="cart-products-summary flex-1 bg-white h-[fit-content] rounded-[14px] shadow p-[20px] flex flex-col gap-[10px]">
            ...
            <button className="text-white text-center w-full p-[8px] border border-[red] rounded-[8px] duration-300 bg-officialRed hover:bg-[#f61225] hover:border hover:border-officialRed h-[38px]">Checkout Now</button>
        </div>
    )
}
