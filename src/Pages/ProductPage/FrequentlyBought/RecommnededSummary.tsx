function RecommnededSummary() {
    return(
        <div className='recommneded-summary flex justify-center items-center border border-[#f0f0f0] rounded-[12px] p-[15px] mt-[20px] bg-background w-full md:w-[300px] h-[fit-content] md:h-[200px]'>
            <div className='summary-contet w-full text-center flex flex-col gap-[10px]'>
                ...
                <div className='recommnedation-options flex justify-between gap-[10px]'>
                    <button className='add-to-cart-btn w-full bg-officialRed text-white py-[10px] rounded-[12px] mt-[10px]'>Add to Cart</button>
