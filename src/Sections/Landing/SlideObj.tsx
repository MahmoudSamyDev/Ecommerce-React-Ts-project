function SlideObj({ gender, img }: { gender: string, img: React.ReactNode }) {
    return (
        <div className='relative w-full h-[100%]'>
            {img}
            <div className='absolute top-[50%] translate-y-[-50%] left-[10%] text-left'>
            ...
            <span
                className='block bg-black text-white text-lg sm:text-sm px-[20px] py-[10px] rounded-[10px] w-[fit-content] cursor-pointer transition ease-linear duration-50 hover:bg-[#343434]'
            >
                Shop Now
            </span>
            </div>
